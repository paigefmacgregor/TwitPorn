...
try:
    ...
    usernames = ['cassandra_nix', 'chanelpreston', 'iluvchristie', 'danecross', 'missdanidaniels', 'dpiercexxx', 'eric_john', 'ericmastersonx', 'erik_everhard', 'evanstonexxx', 'glamchowdr', 'msindiasummer', 'jamesdeen', 'jessieslife', 'itsjessierogers', 'kagneytweets', 'itskarinawhite', 'kayden_kross', 'kaylani_lei', 'keiranlee', 'kendallkarsonxo']
...
helpers.all_tweet_data('twitporn_pt2')