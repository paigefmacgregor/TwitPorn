...
try:
    ...
    usernames = ['penny_pax', 'presleyhartxxx', 'spearstv', 'remymeow', 'richiesbrain', 'imrichiedeville', 'rileyreidx3', 'misssaintxxx', 'sethgamblexxx', 'siripornstar', 'skin_diamond', 'stevenstcroix1', 'stevieshaexxx', 'tashareign', 'itstessalane', 'tommygunnxxx', 'tommypistol', 'trinitystclair', 'xcorvus777']
