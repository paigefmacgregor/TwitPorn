...
try:
    ...
    usernames = ['kristinarosexxx', 'leilani_leeane', 'omgitslexi', 'lexsteele11', 'LilyLaBeau', 'maddyoreillyxxx', 'themandingoclub', 'manuelferrara', 'marcuslondon', 'melina_mason', 'mickbluexxx', 'mollybennett93', 'mrpetexxx', 'missnatashanice', 'xnicoleanistonx', 'nyomibanxxx']
...
helpers.all_tweet_data('twitporn_pt3')